<@layout.ajaxContent title="修改密码 -[$Revision: 2477 $]" scripts="admin/network/doctor/changepassword.js">
	...
	<@layout.content_main>
		...
		<#if isAdmin?exists>
		<form id="form-${code}" action="${base}/admin/network/doctor/adminsavepassword" method="post">
		<#else>
		<form id="form-${code}" action="${base}/admin/network/doctor/savepassword" method="post">
		</#if>
