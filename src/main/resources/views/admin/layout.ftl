<#-- $Id: layout.ftl 3561 2012-09-07 01:35:37Z wzp $ -->
							...
							<div class="head-user flt">
								<div class="span-auto">
									<#if (request.getUserPrincipal().getPrincipal().getNickname())?exists>
										...
										<span>&nbsp;|&nbsp;</span>
										<span>
											<a href="${base}/j_spring_security_logout?forward=/admin/close">退出</a>
										</span>
									<#else>
										<span>&nbsp;|&nbsp;</span>
										<span>
										...
										<span>&nbsp;|&nbsp;</span>
											...
											<a href="${base}/j_spring_security_logout?forward=/admin/login">登录</a>
										</span>
									</#if>
								</div>
							</div>
...
<html>
	...
	<body base="${base}" class="single-page single-page-col2">
		...
		<noscript>
			<div class='noscript error'>您好，要正常运行本系统，浏览器必须支持Javascript！</div>
		</noscript>
		<div class='loadpart' id='loadpart'>
